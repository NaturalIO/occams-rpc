...
/// - If "resp" is specified, the enum is reponse task. The macro will impl [ServerTaskEncode](crate::server::ServerTaskEncode), [ServerTaskDone](crate::server::ServerTaskDone)
